...
public class NotificationService {
    ...
    public void sendDailyIncomeExpenseReminder() {
        ...
        for (ProfileEntity profile : profiles) {
            String body = "Hi " + profile.getFullName() + ",<br><br><br>"
                    ...
                    +"<br><br><br>Best regards,<br>Money Manager Team<br><br><br>";
    ...
    public void sendDailyExpenseSummary() {
        ...
        for (ProfileEntity profile : profiles) {
            ...
            if (!todaysExpenses.isEmpty()) {
                ...
                table.append("<tr style='background-color:#4CAF50;'><th style='border:1px solid #ddd;padding:8px'>S.No</th><th style='border:1px solid #ddd;padding:8px;'>Name</th><th style='border:1px solid #ddd;padding:8px;'>Amount</th><th style='border:1px solid #ddd;padding:8px;'>Category</th></tr>");
                int i = 1;
                ...
                table.append("</table>");
                String body = "Hi "+profile.getFullName()+",<br><br><br> Here is a summary of your expenses for today:<br><br>"+table+"<br><br>Best regards,<br>Money Manager Team<br><br><br>";
